...
function HomeFooter() {
  return (
    <footer className="bg-neutraDark">
      <div className="container p-6 mx-auto">
        <div className="lg:flex">
          <div className="w-full -mx-6 lg:w-2/5">
            <div className="px-6">
              <a href="/" className="w-auto h-7">
                <Logo footer={true} />
              </a>

              <p className="max-w-sm mt-2 text-gray-200">
                Your journey begins here. Explore, discover, and plan your next
                adventure. Start your Travaye experience today!
              </p>

              <div className="flex mt-6 -mx-2">
                <a
                  href="#l"
                  className="mx-2  transition-colors duration-300 hover:text-gray-300 text-primary "
                  aria-label="Reddit"
                >
                  <svg
